        ...
        [
            ...
            dbc.Row(
                [
                    dbc.Col(
                        html.Div(
                            [
                                html.Div("Inventory Management Simulator", className="hero-kicker"),
                                html.H1("IMSim operations console", className="hero-title"),
                                html.P(
                                    (
                                        "Stress-test inventory policies, inspect "
                                        "purchase receipts, and track margin pressure "
                                        "from stockouts, carrying costs, and manual "
                                        "interventions."
                                    ),
                                    className="hero-copy",
                                ),
                        ...
                        dbc.Card(
                            dbc.CardBody(
                                [
                                    ...
                                    html.Div("Day: 1", id="day-display", className="status-value"),
                                    html.Div(
                                        "Status: Paused",
                                        id="sim-status",
                                        className="status-copy",
                                    ),
                                    dbc.Label("Simulation speed (ms)", className="mt-3"),
                                    dcc.Slider(
                                        id="sim-speed-slider",
                                        min=150,
                                        max=2500,
                            ...
                            className="shell-card session-card",
                        ),
                        lg=4,
                    ),
                ],
                className="hero-row g-4",
            ),
                            ...
                            dbc.Card(
                                dbc.CardBody(
                                    [
                                        ...
                                        html.H3("Inventory signal map", className="panel-title"),
                                ...
                                [
                                    dbc.Col(
                                        dbc.Card(
                                            dbc.CardBody(
                                                [
                                                    html.Div("Inventory", className="panel-label"),
                                                    html.H3(
                                    ...
                                    dbc.Col(
                                        dbc.Card(
                                            dbc.CardBody(
                                                [
                                                    html.Div("Exceptions", className="panel-label"),
                                                    html.H3(
                                        ...
                                        dbc.CardBody(
                                            [
                                                ...
                                                dcc.Upload(
                                                    id="upload-item",
                                                    children=html.Div(
                                                        ["Drop files here or ", html.A("browse")]
                                                    ),
                                                    multiple=True,
                                                    accept=".csv,.xlsx",
            ...
            dbc.Modal(
                [
                    ...
                    dbc.ModalFooter(dbc.Button("Close", id="po-overview-close", color="secondary")),
                ],
